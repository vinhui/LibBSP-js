...
import {int, long} from '../../../Util/number'
...
export class NumList implements ILump {
    ...
    public constructor(type: DataType, bsp: BSP, lumpInfo: LumpInfo = new LumpInfo()) {
        this.bsp = bsp
    ...
    public static CreateCopy(original: NumList, type: DataType, bsp: BSP, lumpInfo: LumpInfo = new LumpInfo()): NumList {
        const c = new NumList(type, bsp, lumpInfo)
        c.data = new Uint8Array(original.data)
        return c
    }

    public static CreateFromData(data: Uint8Array, type: DataType, bsp: BSP, lumpInfo: LumpInfo = new LumpInfo()): NumList {
        if (!data) {
    ...
    public set(index: int, value: long): void {
    ...
    public copyTo(other: long[], startIndex: int): void {
    ...
    public [Symbol.iterator](): { next: () => { value: long, done: boolean } } {
        let index = -1

        return {
            next: (): { value: long, done: boolean } => {
                return {
