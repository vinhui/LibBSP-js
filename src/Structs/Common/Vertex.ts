...
export class Vertex {
    ...
    public uv0: Vector2 = new Vector2()
    public uv1: Vector2 = new Vector2()
    public uv2: Vector2 = new Vector2()
    public uv3: Vector2 = new Vector2()
    public tangent: Vector4 = new Vector4()
